...
import { ModelOption, AnalysisResult, ExpertResult, ReviewResult, MessageAttachment } from '../../types.js';
import { cleanJsonString } from '../../utils.js';
import { MANAGER_SYSTEM_PROMPT, MANAGER_REVIEW_SYSTEM_PROMPT } from './prompts.js';
import { withRetry } from '../utils/retry.js';
import { generateContent as generateOpenAIContent } from './openaiClient.js';
...
export const executeManagerAnalysis = async (
  ...
  if (isGoogle) {
    ...
    try {
      ...
      logger.error("Manager", "Analysis generation failed (OpenAI)", {
        message: e?.message,
        status: e?.status,
        error: e?.error,
